...
void CDao::Initialize()
{
	CBmpManager::Get_Instance()->Insert_Bmp(L"../Image/Obj/Character/Dao/dao.bmp", L"Dao");
	CBmpManager::Get_Instance()->Insert_Bmp(L"../Image/Obj/Character/Dao/dao_bubble.bmp", L"DaoBubble");
	CBmpManager::Get_Instance()->Insert_Bmp(L"../Image/Obj/Character/Dao/dao_pop.bmp", L"DaoPop");
...
void CDao::Render(HDC _DC)
{
	...
	case OBJSTATE::BUBBLE:
		...
		hMemDC = CBmpManager::Get_Instance()->Find_Image(L"DaoBubble");
	...
	case OBJSTATE::DEAD:
		...
		hMemDC = CBmpManager::Get_Instance()->Find_Image(L"DaoPop");
		GdiTransparentBlt(_DC, m_tRect.left - 5, m_tRect.top - 20
			, 50, 60, hMemDC
			, 0, 0
			, 70, 70
